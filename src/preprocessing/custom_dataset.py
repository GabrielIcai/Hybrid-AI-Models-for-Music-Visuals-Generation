...
class CustomDataset(torch.utils.data.Dataset):
    ...
    def __getitem__(self, idx):
        ...
        try:
            ...
            required_columns = ['RMS', 'ZCR', 'Mean Absolute Amplitude', 'Crest Factor', 
            ...
            labels = torch.tensor(row.iloc[list(range(1, 5)) + list(range(6, 8))].values.astype(float), dtype=torch.float32)
