...
from src.preprocessing import CustomDataset, load_data, mean_std_image, normalize_columns, normalize_images, split_dataset, c_transform
...
from src.preprocessing import CustomDataset,c_transform, load_data, mean_std_image, split_dataset
#Parametros
...
def main():
    ...
    #DataLoader
    train_loader = DataLoader(train_dataset, batch_size=16, collate_fn=collate_fn, shuffle=False)
    val_loader = DataLoader(test_dataset, batch_size= 16, collate_fn=collate_fn, shuffle=False)
